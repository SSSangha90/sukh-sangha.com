...
var budgetController = (function(){
	...
	var data = {
		...
		budget:0,
		percentage: -1 //non existant whilst there's no values
	};
...
//Creating an object to store all the strings, html classes
	...
	return {
		...
		//use the removeChild method, but first need to know the parent
