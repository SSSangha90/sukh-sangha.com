$(document).ready(function(){
	...
	/* Animations */
	$('.js--wp-projects1').waypoint(function(direction){
		$('.js--wp-projects1').addClass('animated fadeIn');
	}, {
		offset: '50%'
	});
	
	$('.js--wp-projects2').waypoint(function(direction){
		$('.js--wp-projects2').addClass('animated fadeIn');
	}, {
		offset: '75%'
	});
	...
	$('.js--wp-details').waypoint(function(direction){
		$('.js--wp-details').addClass('animated fadeInLeft');
	}, {
		offset: '70%'
	});
